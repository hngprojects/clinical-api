...
def upgrade() -> None:
    ...
    # PostgreSQL < 12.  We execute it in a separate COMMIT-ed connection so
    # the migration is safe across all supported server versions.
    conn = op.get_bind()
    ...
    op.drop_constraint('notification_medical_case_id_fkey', 'notification', type_='foreignkey')
